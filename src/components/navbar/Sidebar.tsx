...
const Sidebar: React.FC<SidebarProps> = ({openNav, closeNav}) => {
    ...
    return (
    <div className={openNav ? 'sidebar active' : 'sidebar'} onClick={closeNav}>
        <div className="container">
            ...
            <div className="close-btn" onClick={closeNav} ><GrClose className="icon" /></div>
            <div className="subnav-menu" onClick={e => e.stopPropagation()}>
